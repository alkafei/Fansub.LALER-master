...
def oploverz(x):
	...
	zippy_regex=re.compile(r"<a href=\"(https://94lauin.com/.....)\" rel=\"noopener\"\s+target=\"_blank\">[\sZippyshare]+</a>")
	mirror_regex=re.compile(r"<a\s+href=\"(https://94lauin.com/.....)\">[\sMirror]+</a>")
	...
	mirror=re.findall(mirror_regex,str(html2))
